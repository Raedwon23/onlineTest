    ...
    <div class="wrapper">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <div class="form-group <?php echo (!empty($password_err)) ? 'has-error' : ''; ?>">
                ...
                <input type="password" name="password" onfocus="this.value=''" class="form-control">
			...
			<br>
			<!--<p><font font-family: Arial, sans-serif; color="#C11C1C">Don't have an account? <a href="adminsignup.php"></font><font font-family: Arial, sans-serif; color="orange">Sign up now</font></a>.</p>
            -->
